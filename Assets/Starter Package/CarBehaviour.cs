...
public class CarBehaviour : MonoBehaviour
{
    ...
    public TextMesh AboveKikiText; // Drag and drop your 3D TextMesh object here

    private PackageSpawner _packageSpawner;

    private void Start()
    {
        // Find the PackageSpawner in the scene
        _packageSpawner = FindObjectOfType<PackageSpawner>();
        if (_packageSpawner == null)
        {
            Debug.LogError("No PackageSpawner found in the scene.");
        }
    }
